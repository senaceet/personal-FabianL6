...
<body style="background: #56ab2f;  background: -webkit-linear-gradient(to right, #a8e063, #56ab2f); background: linear-gradient(to right, #a8e063, #56ab2f); ">

<header class="mb-5">


    <nav class="navbar navbar-expand-lg navbar-light bg-dark ">
        <img class="w-25 mr-5" src="https://comefruta.es/wp-content/uploads/logo-horizontal-mefruta-saborysalud.png" alt="fruteria">
