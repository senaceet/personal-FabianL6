...
class ConductorController extends Controller
{
    ...
    public function store(Request $request){
        ...
        return redirect('conductor')->with('create', 'Conductor Registrado');
    }
    ...
    public function destroy($id){
        ...
        return redirect('conductor')->with('delete', 'Conductor Eliminado');
    }
    ...
    public function update(Request $request, $id){
        ...
        return redirect('conductor')->with('edit', 'Conductor Actualizado');
    }
