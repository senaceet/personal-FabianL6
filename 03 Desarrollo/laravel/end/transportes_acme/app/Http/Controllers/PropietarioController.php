...
class PropietarioController extends Controller
{
    ...
    public function store(Request $request){
        ...
        return redirect('propietario')->with('create', 'Propietario Registrado');
    }
    ...
    public function destroy($id){
        ...
        return redirect('propietario')->with('delete', 'Propietario Eliminado');
    }
    ...
    public function update(Request $request, $id){
        ...
        return redirect('propietario')->with('edit', 'Propietario Actualizado');
    }
